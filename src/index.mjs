...
const schemas = {
  ...
  furniture:                loadSchema('furniture.schema.json'),
  packaging:                loadSchema('packaging.schema.json'),
}
...
export const validateFurniture      = makeValidator('https://dpp.gs/schemas/v2026.05/furniture.schema.json')
export const validatePackaging      = makeValidator('https://dpp.gs/schemas/v2026.05/packaging.schema.json')
